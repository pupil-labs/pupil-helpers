...
class Event_Capture(Plugin):
    ...
    def init_gui(self):
        ...
        self.button = ui.Thumb('event',self,setter=self.add_event,getter=lambda: True, label='Event Capture',hotkey='e')
    ...
    def add_event(self,_):
    	if self.recording:
        	self.events['my_event_name'] = self.g_pool.capture.get_timestamp
