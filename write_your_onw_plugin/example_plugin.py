...
class Example_Plugin(Plugin):
    ...
    def init_gui(self):
        ...
        # here we use glfw to create a new window: 'share' should point to the main gl context so we can reuse textures from there.
    ...
    def update(self,frame,events):
        ...
        # Keep in mind that inplace modification of frame.img or frame.gray will show up in later run plugins and in the main window.
        # To illustrage this point I will draw something into the image using Opencv draw funtions
        cv2.putText(self.img,"Hi from Plugin. The variable is: %s"%self.my_var,(100,90), cv2.FONT_HERSHEY_SIMPLEX,1.0,(255,150,100))
    ...
    def gl_display(self):
        ...
        make_coord_system_pixel_based(self.img.shape)
